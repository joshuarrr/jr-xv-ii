			...
			>
				...
				<article className="blog-entry">
					...
					<ol>
						...
						<li>We’re validating fields as you type. Do the messages that appear on invalid entry prove helpful or just distracting? To make sure we could answer this question, we built into the prototype a devious ploy to make sure we triggers an error state: we required a nine digit zip-code.</li>
						<li>I’ve always hated asterisks that denote required fields. I prefer keeping optional fields to a minimum and denoting them as  optional. It seems like that is becoming more ubiquitous, and  Nielsen Norman Group seems to <a href="https://www.nngroup.com/articles/web-form-design/" rel="external" target="UX Guidelines" className="external-link">agree with me</a>, but we had stakeholders who were resistant to that pattern. Would our users understand that all fields not marked optional were required?</li>
					</ol>
					<hr className="section-break" />
					<p>To answer these questions and to get a better sense of our users’ experiences, we had a testing session of 9 people that fit our demographic: mostly women, aged between 35-65. <a href="https://docs.google.com/document/d/1GjGPQNAGLXYjFWAWhwh6UM7wt07ZviltwO3tPwb8Y1c/edit?usp=sharing" rel="external" target="googledocs" className="external-link">Our test script</a> made sure to ask questions about their browsing behaviors so that we could estimate their general computer skill level. Most of our test subjects were relatively computer savvy, but a couple were more timid and challenged by things like passwords, registration forms, and autocomplete. We also had the opportunity to informally test one of our participant’s son - a 14 year old who filled out the forms so quickly and effortlessly that we didn’t even include his experience in our analysis.</p>
